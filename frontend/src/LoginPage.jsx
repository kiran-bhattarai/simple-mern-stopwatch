...
function LoginPage() {
    ...
    const loginFunction = async () => {
        try {
            ...
            setMessage("Server not reachable", err)
        }
    }
    ...
    return (
        ...
        <div className="bg-gray-900 h-screen items-center justify-center flex">
            <div className="flex flex-col items-center justify-start w-80 bg-gray-800 rounded-xl relative">
                <h1 className="font-medium text-4xl m-4 text-white mb-12">Log In</h1>
                ...
                <button onClick={loginFunction} className="cursor-pointer bg-amber-700 text-white p-[2px] px-[6px] font-medium text-lg rounded mt-2 hover:scale-110 hover:bg-amber-800 transition duration-300">Log In</button>
                <Link to="/signup" >
